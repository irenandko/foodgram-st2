    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator(message='Для имени пользователя необходимо использоватьтолько буквы, цифры и символы "@ . -"', regex='^[\\w.@-]+$')], verbose_name='Имя пользователя')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='users_avatars/', verbose_name='Фото профиля')),
